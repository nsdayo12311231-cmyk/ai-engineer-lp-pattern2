        ...
        >
          {skillPoints.map((point, index) => (
            ...
            >
              ...
              <p style={{ color: '#374151', margin: 0, whiteSpace: 'pre-line', fontWeight: 'bold' }}>
                <span className="hidden lg:inline" style={{ fontSize: '22px' }}>{point.pc}</span>
                <span className="lg:hidden" style={{ fontSize: '16px' }}>{point.mobile}</span>
              </p>
            </div>
          ))}
        </div>
